    ...
    return <div className="layout-topbar">
            <div className="layout-topbar-inner">
                <div className="layout-topbar-logo-container">
                    <Link href="/" aria-label="PrimeReact logo" className="layout-topbar-logo">
                    ...
                    <Link href="/" aria-label="PrimeReact logo" className="layout-topbar-icon">
                ...
                <ul className="flex list-none m-0 p-0 gap-2 align-items-center">
                    ...
                    {true && (
                        <li>
                            <button type="button" className="p-button flex-shrink-0 flex border-1 w-2rem h-2rem p-0 align-items-center justify-content-center transition-all transition-duration-300 min-w-0" >
